<template>
  <div class="mx-5">
    <h1 class="overflow-y-hidden mb-5">Shopping Cart</h1>

    <div class="shopping-cart">
      <div class="column-labels">
        <label class="product-image text-black">Image</label>
      ...
      <div class="product" v-for="(product, index) in products" :key="index">
        ...
        <div class="product-quantity">
          <input type="number" v-model="product.quantity" @input="updateQuantity(index)">
        </div>
...
export default {
  ...
  methods: {
    updateQuantity(index) {
      this.products[index].total = (this.products[index].price * this.products[index].quantity).toFixed(2);
    ...
    recalculateCart() {
      // Recalculate your totals here if needed
    },
  },
};
</script>
